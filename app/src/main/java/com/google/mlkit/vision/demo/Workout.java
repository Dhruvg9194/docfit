...
public class Workout extends AppCompatActivity implements SensorEventListener, StepListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                sensorManager.registerListener(Workout.this, accel, SensorManager.SENSOR_DELAY_FASTEST);
        ...
        BtnStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                ed.apply();
                sensorManager.unregisterListener(Workout.this);
...
//        }
        if(id==R.id.menu_home){
            Intent i = new Intent(this,EntryChoiceActivity.class);
            startActivity(i);
            finish();
        }
